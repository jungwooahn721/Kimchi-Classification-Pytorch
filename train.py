...
from data_loader.data_loaders import KimchiDataLoader
from base.base_data_loader import BaseDataLoader
import data_loader.data_loaders as module_data
from data_loader.kimchi_dataset import kimchi_dataset
...
if __name__ == '__main__':
    ...
    options = [
        ...
        CustomArgs(['--lrss', '--schedule_step'], type=int, target='lr_scheduler;args;step_size'),
    ]
